...
function Shine() {
  return (
    <>
    <div className=" relative bg-[#D2D9D8] bg-opacity-90 w-full h-[100vh] sm:h-[80vh] md:h-[150vh]">
      ...
      <div className='md:w-[15vw] rounded-md overflow-hidden absolute top-[51%] sm:top-[50%] md:top-[53%] left-[50%] -translate-x-1/2 -translate-y-1/2'>
