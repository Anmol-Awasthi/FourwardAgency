...
function Shine() {
  return (
    <>
    <div className=" relative bg-[#D2D9D8] bg-opacity-90 w-full h-screen md:h-[150vh]">
      <div className='w-[70vw] text-6xl md:text-[22vh] font-formula font-extrabold text-center absolute top-[30%] md:top-[46vh] left-[50%] -translate-x-1/2 -translate-y-1/2 tracking-wide md:leading-[7.5rem] text-[#001514]'>
        SHINE IN THE DIGITAL WORLD
      </div>
      <div className='md:w-[15vw] rounded-md overflow-hidden absolute top-[50%] md:top-[53%] left-[50%] -translate-x-1/2 -translate-y-1/2'>
